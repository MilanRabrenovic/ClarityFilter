  ...
  try {
    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        status(
          `Added ${newTermsCount} new terms, ${newSitesCount} new sites, ${newImageCount} new blocked images`,
          "success"
        );
